    ...
    >
      ...
      <div className='flex justify-center'>
        <Link
          ...
          target='_blank'
          rel='noopener noreferrer'
          className='from-purple-pink-600 to-purple-pink-500 flex items-center gap-2 rounded-full bg-linear-to-r px-6 py-3 text-sm font-medium text-white transition-opacity hover:opacity-90'
        >
          View More on GitHub
        </Link>
      </div>
